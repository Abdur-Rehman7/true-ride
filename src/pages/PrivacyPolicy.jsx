      ...
      <div>
        ...
        <div className="px-10 lg:px-48 md:px-20 mx-auto my-8 ">
          ...
          <div className="text-[22px] text-[#605A5B] my-2">
            ...
            ullamco laboris nisi ut aliquip exea in commodo consequat Duis aute
            irure dolor in reprehenderit in voluptate velit esse cillum dolore
            eu fugiat nulla pariatur Excepteur sint occaecat cupidatat non
            proidentktl sunt in culpa qui officia deserunt mollit anim id est
            laborum Sed ut perspiciatis unde omnis iste natus error sit
            voluptatem accusani um doloremque laudantium totamrem aperiam eaque
            ipsa quae ab illo inventore veritatis et quasi architecto beatae
            vitae dicta sunt explicabo Nemo enim ipsam volupt
          </div>

          <div className="text-[36px] font-semibold my-4">
          ...
          <div className="text-[36px] font-semibold text-[#131212] my-4">How We Use Cookies?</div>
