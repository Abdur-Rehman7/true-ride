  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-[40px] px-20 my-8 ">
        <div className="mx-8">
          <div className="text-[54px] my-4">Our Fonding Story</div>
          <div>
      ...
      <div className="px-20 my-8">
        ...
        <div className="grid grid-cols-2 items-center border-b border-[#E4E4E4] py-2">
          ...
          <div className="text-[20px] text-[#575757]">Browse thousands of verified listings or list your car for free.</div>
        </div>
        <div className="grid grid-cols-2 items-center border-b border-[#E4E4E4] py-2">
          <div className="text-[36px] font-semibold">Car Maintenance & Repairs</div>
          <div className="text-[20px] text-[#575757]">Book trusted garages and mobile mechanics near you.</div>
        </div>
        <div className="grid grid-cols-2 items-center border-b border-[#E4E4E4] py-2">
          <div className="text-[36px] font-semibold">Insurance & Financing</div>
          <div className="text-[20px] text-[#575757]">Compare the best rates and secure coverage or loans in minutes.</div>
        </div>
        <div className="grid grid-cols-2 items-center border-b border-[#E4E4E4] py-2">
          <div className="text-[36px] font-semibold">Parts & Accessories</div>
          <div className="text-[20px] text-[#575757]">Discover a wide range of genuine car parts and custom add-ons.</div>
        </div>

        <div className="my-8">
          <img src={foundervideo} alt="founder video" className="rounded-[12px]" />
        </div>
      </div>

      <div className="px-20 my-8 rounded-[24px]">
        <Testimonial />
      </div>
