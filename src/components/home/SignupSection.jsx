      ...
      <div className="grid grid-cols-2 bg-[#FAFAFA] px-4 mb-[44px]">
        <div className="flex flex-col gap-[12px]">
          ...
          <div className="text-[#2B2B2B]">
            Search thousands of real listings from verified sellers. <br />{" "}
            Compare prices, check car history, and connect instantly.
            <br /> Whether you're buying or selling.
          </div>
          <div>
        ...
        <div className="relative">
          <img src={carimg} alt="car img" className="absolute top-20" />
        </div>
      </div>
    </>
  );
